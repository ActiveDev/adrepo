package com.activedevsolutions.calcdemo2;
...
import com.activedevsolutions.calcdemo2.model.CalcError;
import com.activedevsolutions.calcdemo2.model.CalcResult;

/**
 * Very simple demonstration of a REST controller that returns a CalcResult. It
 * also includes an exception handler that will return a CalcError.
 */
@ControllerAdvice
@RestController
public class CalcController {
	 ...
	 * 
	 * @param numberOne
	 *            is the first value involved in the addition
	 * @param numberTwo
	 *            is used to add to the first value
