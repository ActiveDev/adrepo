...
public class BlockChainTest {
	...
	public void testOverall() {
		...
		try {
			...
			block1.addTransaction(blockChain.getStartingWallet().sendFunds(realUserWallet.getKeyManager().getPublicKey(), new CurrencyFormat(40)));
			...
			block2.addTransaction(blockChain.getStartingWallet().sendFunds(realUserWallet.getKeyManager().getPublicKey(), new CurrencyFormat(1000)));
			...
			block3.addTransaction(realUserWallet.sendFunds(blockChain.getStartingWallet().getKeyManager().getPublicKey(), new CurrencyFormat(20)));
			System.out.println("\nWalletA's balance is: " + blockChain.getStartingWallet().getBalance());
			System.out.println("WalletB's balance is: " + realUserWallet.getBalance());
